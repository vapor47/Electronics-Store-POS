            ...
            <asp:View ID="TotalSalesReport" runat="server">
                ...
                <asp:Panel ID="Panel13" runat="server">
                    ...
                    <div id="popup" style="max-height:300px;overflow-y:scroll;">
                        <asp:GridView ID="GridView4" runat="server" BackColor="White" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical" AutoGenerateColumns="False">
